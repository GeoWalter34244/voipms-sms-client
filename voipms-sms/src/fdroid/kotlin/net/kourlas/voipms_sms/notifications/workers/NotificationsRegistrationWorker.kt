...
/**
 * Service that registers a VoIP.ms callback for each DID using ntfy.sh.
 */
class NotificationsRegistrationWorker(
     ...
     * Note: For ntfy.sh integration, users must manually configure the callback URL
     * in their VoIP.ms account settings to point to their ntfy topic.
     */
                ...
                didResponses.add(
                    httpPostWithMultipartFormData(
                        ...
                        mapOf(
                            ...
                            "did" to did,
                            "enable" to "1",
                            "url_callback_enable" to "0", // Disable callback - user configures manually
    ...
    companion object {
        /**
         * Registers a VoIP.ms callback for each DID using ntfy.sh.
         */
